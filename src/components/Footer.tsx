...
const styles = StyleSheet.create({
  ...
  cen: {width: 35, height: 35},
  cen1: {width: 35, height: 35},
  cen2: {width: 35, height: 35},
  cen3: {width: 35, height: 35},
  cen4: {width: 35, height: 35},
  ci: {flexDirection: 'row', marginTop: 15, justifyContent: 'space-around'},
